        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkingDayStartTime = table.Column<TimeOnly>(type: "time without time zone", nullable: false),
                    WorkingDayEndTime = table.Column<TimeOnly>(type: "time without time zone", nullable: false),
                    LateGraceMinutes = table.Column<int>(type: "integer", nullable: false),
                    WeekendConfig = table.Column<string>(type: "text", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uuid", nullable: true),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    UpdatedBy = table.Column<Guid>(type: "uuid", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailOrUsername = table.Column<string>(type: "text", nullable: true),
                    OccurredAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    IpAddress = table.Column<string>(type: "text", nullable: true),
                    UserAgent = table.Column<string>(type: "text", nullable: true),
                    DeviceSummary = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_office_branches", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_allowed_networks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_allowed_networks_office_branches_BranchId",
                        column: x => x.BranchId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_users_office_branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "office_branches",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClockInUserAgent = table.Column<string>(type: "text", nullable: true),
                    ClockOutUserAgent = table.Column<string>(type: "text", nullable: true),
                    ClockInDeviceSummary = table.Column<string>(type: "text", nullable: true),
                    ClockOutDeviceSummary = table.Column<string>(type: "text", nullable: true),
                    ClockInNetworkValidation = table.Column<string>(type: "text", nullable: true),
                    ClockOutNetworkValidation = table.Column<string>(type: "text", nullable: true),
                    ClockInNetworkRuleId = table.Column<Guid>(type: "uuid", nullable: true),
                    ClockOutNetworkRuleId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_attendance_records_allowed_networks_ClockInNetworkRuleId",
                        column: x => x.ClockInNetworkRuleId,
                        principalTable: "allowed_networks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_attendance_records_allowed_networks_ClockOutNetworkRuleId",
                        column: x => x.ClockOutNetworkRuleId,
                        principalTable: "allowed_networks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_attendance_records_office_branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "office_branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_allowed_networks_BranchId",
                table: "allowed_networks",
                column: "BranchId");

            migrationBuilder.CreateIndex(
                name: "IX_attendance_records_BranchId",
                table: "attendance_records",
                column: "BranchId");

            migrationBuilder.CreateIndex(
                name: "IX_attendance_records_ClockInNetworkRuleId",
                table: "attendance_records",
                column: "ClockInNetworkRuleId");

            migrationBuilder.CreateIndex(
                name: "IX_attendance_records_ClockOutNetworkRuleId",
                table: "attendance_records",
                column: "ClockOutNetworkRuleId");

            migrationBuilder.CreateIndex(
                name: "IX_attendance_records_UserId_AttendanceDate",
                table: "attendance_records",
                columns: new[] { "UserId", "AttendanceDate" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_office_branches_Code",
